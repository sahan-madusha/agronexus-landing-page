    ...
    <section className="hero-section">
      <div className="hero-overlay">
        <div className="hero-content">
          <div className="hero-badge">AI + IoT Innovation</div>
          ...
          <div className="hero-buttons">
            <button
              ...
              onClick={() => {
                window.location.href = `mailto:sahanmadusha@gmail.com?subject=Demo Request for Smart Greenhouse&body=Hello,%0D%0A%0D%0AI would like to request a demo of the AI-powered smart greenhouse system.%0D%0A%0D%0AThank you.`;
              }}
            >
              Request a Demo
